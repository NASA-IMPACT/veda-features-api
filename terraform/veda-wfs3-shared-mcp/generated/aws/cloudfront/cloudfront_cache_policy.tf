...
resource "aws_cloudfront_cache_policy" "tfer--28a8e074-fa92-49d8-b10d-b4f912db6176" {
  default_ttl = "86400"
  max_ttl     = "31536000"
  min_ttl     = "1"
  name        = "try-q-all"
...
resource "aws_cloudfront_cache_policy" "tfer--d365e40d-cd44-48b4-9b1b-c1b82e278e8e" {
  comment     = "Allow Authorization and Host headers to pass through"
  default_ttl = "86400"
  max_ttl     = "31536000"
  min_ttl     = "1"
  name        = "SendHeadersToAPIGateway"
